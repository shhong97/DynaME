...
def add_adapters_(parent_module: nn.Module, args, top_level=True):
    for name, module in parent_module.named_children():
        # xPatch의 depthwise conv는 제외
        if hasattr(args, 'model') and 'xPatch' in args.model and isinstance(module, nn.Conv1d) and module.groups > 1:
            continue
        elif args.tune_mode == 'all_down_up' and isinstance(module, (nn.Conv1d, nn.Linear, transformers.Conv1D,
