...
class Dataset_ETT_hour(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='OT', scale=True, timeenc=0, freq='h', train_only=False, border=None, past_num=0):
    ...
    def __getitem__(self, index):
        ...
        if self.past_num > 0:
            return seq_x, seq_y, seq_x_mark, seq_y_mark, self.data[max(self.border[0]+ s_end - self.past_num, 0):self.border[0] + s_end]
        else:
...
class Dataset_ETT_minute(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='OT', scale=True, timeenc=0, freq='t', train_only=False, border=None, past_num=0):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
