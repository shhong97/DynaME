...
data_settings = {
    ...
    'Traffic': {'data': 'traffic.csv', 'T':'OT', 'M':[862,862], 'S':[1,1], 'prefetch_batch_size': 2},
...
pretrain_lr_online_dict = {
    ...
    'xPatch': {'ETTh2': 0.0001, 'ETTm1': 0.0001, 'Traffic': 0.001, 'Weather': 0.00001, 'ECL': 0.0005},
